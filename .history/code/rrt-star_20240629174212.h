...
class Graph {
    ...
    public:
        ...
        void add_node(data_t d, double cost);

        double cost(data_t d);

        list<data_t> get_neighbors(data_t q, double radius);

        list<data_t> k_nearest_neighbors(data_t q, size_t num_neighbors);
